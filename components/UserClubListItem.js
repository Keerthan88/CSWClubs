...
const UserClubListItem = props =>{

    const [modalVisible, setModalVisible] = useState(false);
    const joinedClubs = useSelector(state => state.clubs.allJoinedClubs);
    const clubMembers = joinedClubs.filter(member => (member.clubid===props.id));

    const openSetMeeting = () =>{
        props.onSelect();
        ...
        <View style = {styles.display}>
            ...
            <View style={styles.background}>
                ...
                <View style={styles.item}>
                    <TouchableOpacity
                        onPress={openSetMeeting}
                    >
                        <Text style = {styles.exittext}> Set A Meeting </Text>
                    </TouchableOpacity>
                </View>
                <View style={styles.item}>
                    <TouchableOpacity
